...
export struct Matrix3 {
  ...
  Matrix3 &operator+=(const Matrix3 &mat3) { return *this = *this + mat3; }
  Matrix3 &operator-=(const Matrix3 &mat3) { return *this = *this - mat3; }
  Matrix3 &operator*=(const Matrix3 &mat3) { return *this = *this * mat3; }
  ...
  Matrix3 &operator*=(float scalar) { return *this = *this * scalar; }
  Matrix3 &operator/=(float scalar) { return *this = *this / scalar; }

  Matrix3 operator-() const { return *this * -1; }
  ...
  bool operator!=(const Matrix3 &mat3) const { return !(*this == mat3); }

  static const Matrix3 Zero;
  static const Matrix3 Identity;
};

export Matrix3 operator*(float scalar, const Matrix3 &mat3) { return mat3 * scalar; }

export std::ostream &operator<<(std::ostream &os, const Matrix3 &mat) {
...
Matrix3 const Matrix3::Zero(0);
Matrix3 const Matrix3::Identity(1, 0, 0, 0, 1, 0, 0, 0, 1);